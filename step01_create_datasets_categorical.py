...
dataset_file = c.file_all_datasets
...
# %%
all_datasets = {}
for params in tqdm(all_param_configs):
...
all_datasets["normal_target_encoding--window_NA--emb_NA--batch_NA--num-epochs_NA--is_cbow_NA--seperated_NA--actonly_NA--loss_NA--val-loss_NA"] = {"data": tmp_data, "emb_dict":None}
...
all_datasets["normal_label_encoding--window_NA--emb_NA--batch_NA--num-epochs_NA--is_cbow_NA--seperated_NA--actonly_NA--loss_NA--val-loss_NA"] = {"data": tmp_data, "emb_dict":None}
...
tmp_data, _ = pp_cat_target_encoding(tmp_data, c.all_time_columns + ["Resource"], c.column_Remtime)
tmp_data, _ = pp_num_minmax(tmp_data, xcols=c.all_remaining_cols + c.all_time_columns)
all_datasets["normal_dummy_encoding--window_NA--emb_NA--batch_NA--num-epochs_NA--is_cbow_NA--seperated_NA--actonly_NA--loss_NA--val-loss_NA"] = {"data": tmp_data, "emb_dict":None}
pickle.dump(all_datasets, io.open(dataset_file, "wb"))
