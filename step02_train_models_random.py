...
all_datasets = pickle.load(open(c.file_all_datasets_random, "rb"))
...
for dataset_name, data_set in all_datasets_splits.items():
    ...
    current_results.to_csv(io.open(c.file_all_results_random, 'w'), line_terminator='\n')
    json.dump(hparam_mapper, io.open(c.file_hparams_json_random, 'w'))
# %%
current_results
# %%
